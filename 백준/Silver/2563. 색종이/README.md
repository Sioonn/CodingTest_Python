...
### 고찰
<p>겹친 부분을 어떻게 중복없이 넓이를 구할 수 있을까에 대해 엄청 고민을 많이 했다. 아무리봐도 실버4급 문제는 아닌데... 도저히 모르겠어서 힌트를 검색해보고 풀었다. 중복이 안되게 수학적으로 계산해보는게 아닌, 모눈종이 자체를 구현하고 색칠하는 형식으로 생각하면 굉장히 쉽게 풀렸다. 문제를 다양한 시각에서 바라보자!! </p>
